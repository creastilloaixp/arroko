...
export const GiftIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 1 0 9.375 7.5H12m0-2.625V7.5m0-2.625A2.625 2.625 0 1 1 14.625 7.5H12m0 0H9.375m0 0A2.625 2.625 0 1 0 12 4.875M12 7.5h2.625m2.625 0A2.625 2.625 0 1 0 12 4.875m2.625 2.625V11.25m0 0A2.625 2.625 0 0 1 12 13.875V11.25m-2.625 0A2.625 2.625 0 0 0 12 13.875V11.25m0 0H12m11.25-3.375v2.625c0 .621-.504 1.125-1.125 1.125H3.875c-.621 0-1.125-.504-1.125-1.125V7.875" />
    </svg>
);

export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.226A3 3 0 0 1 18 15.72M6 21a2.25 2.25 0 0 1-2.25-2.25V15a3 3 0 1 1 6 0v3.75A2.25 2.25 0 0 1 7.5 21h-1.5m-3-3.75V15a3 3 0 0 1 6 0v3.75m0 0H9m1.5-3.75h.008v.008H10.5v-.008Zm-3 0h.008v.008H7.5v-.008Zm1.5 0h.008v.008H9v-.008Zm-1.5 0h.008v.008H7.5v-.008Z" />
    </svg>
);
...
export const WhatsAppIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.894 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.433-9.89-9.889-9.89-5.452 0-9.887 4.434-9.889 9.891.001 2.23.651 4.35 1.857 6.097l-1.214 4.428 4.564-1.189zM9.062 7.193c-.136-.34-.27-.357-.404-.365-.118-.008-.263-.008-.404-.008-.14 0-.378.068-.582.347-.204.279-.771.758-.771 1.845s.789 2.147.898 2.311c.11.164 1.554 2.563 3.803 3.537 1.84.78 2.23.626 2.63.582.4-.044.771-.18 1.006-.347.26-.186.404-.496.546-.837.142-.34.07-.626-.043-.734-.113-.107-.258-.164-.404-.231-.145-.068-.904-.446-1.045-.496-.14-.05-.242-.078-.344.078-.102.156-.395.496-.484.594-.09.098-.182.112-.327.068-.145-.044-.613-.225-1.168-.72-1.045-1.082-1.39-1.297-1.488-1.491-.098-.194-.009-.303.06-.404.068-.102.145-.165.218-.232.072-.068.12-.112.182-.187.06-.075.03-.14-.023-.186-.053-.047-.344-.816-.47-.982z"/>
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.05 1.05 0 0 0-1.485 0L12 15.021V12.5a.97.97 0 0 1 .117-.456l1.52-3.418a1.2 1.2 0 0 0-.256-1.453l-1.148-1.026a.97.97 0 0 0-1.332 0l-1.148 1.026a1.2 1.2 0 0 0-.256 1.453l1.52 3.418.117.456v2.521l-1.98-1.98a1.05 1.05 0 0 0-1.485 0l-3.72 3.72A2.123 2.123 0 0 1 3 16.982V12.7c0-.97.616-1.813 1.5-2.097L6.6 9.94a1.05 1.05 0 0 0 .565-1.564l-1.52-3.418a1.2 1.2 0 0 1 .256-1.453l1.148-1.026a.97.97 0 0 1 1.332 0l1.148 1.026a1.2 1.2 0 0 1 .256 1.453l-1.52 3.418a1.05 1.05 0 0 0 .565 1.564l2.1-1.051" />
    </svg>
);
...
export const ChatBubbleOvalLeftEllipsisIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.53-0.417m-4.754-4.254a4.99 4.99 0 0 0-1.751 3.513c-.274 1.767-2.07 2.622-3.323 1.408C.27 15.93 0 14.544 0 12.91a8.956 8.956 0 0 1 2.97-6.523c1.023-.977 2.4-1.46 3.845-1.46a8.957 8.957 0 0 1 6.523 2.97c.341.326.65.682.915 1.055" />
  </svg>
);
